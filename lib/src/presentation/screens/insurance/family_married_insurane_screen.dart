...
import '../../../business_logic/package_cubit/package_cubit.dart';
import '../../../constants/colors.dart';
import '../../../constants/const_methods.dart';
import '../../widgets/text_input_field.dart';
import 'individual_insurance_screen.dart';

class FamilyMarriedInsuranceScreen extends StatefulWidget {
  const FamilyMarriedInsuranceScreen({super.key});

  @override
  State<FamilyMarriedInsuranceScreen> createState() =>
      _FamilyMarriedInsuranceScreenState();
}

class _FamilyMarriedInsuranceScreenState
    extends State<FamilyMarriedInsuranceScreen> {
              ...
              child: Column(
                children: [
                  FieldWithLabel(
                    ...
                    readOnly: true,
                    controller: PackageCubit.get(context).partnerController,
                    label: context.husbandOrWifeName,
                    borderColor: AppColors.grey3,
                  ),
                  Column(
                    children: List.generate(
                      PackageCubit.get(context)
                          .sonOrDaughterNameControllers
                          .length,
                      (index) => FieldWithLabel(
                          ...
                          controller: PackageCubit.get(context)
                              .sonOrDaughterNameControllers[index],
                          label: context.sonOrDaughterName,
                          borderColor: AppColors.grey3,
                          suffix: InkWell(
                            onTap: () {
                              setState(() {
                  ...
                  GestureDetector(
                    onTap: () {
                      if (PackageCubit.get(context).children.length < 3) {
                        setState(() {
                          PackageCubit.get(context)
                              .sonOrDaughterNameControllers
                              .add(TextEditingController());
                          PackageCubit.get(context).children.add(Person());
                        });
                      }
                    },
                    child: DottedBorder(
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              context.enterMoreSonOrDaughterName,
                              style: const TextStyle(
                                color: Colors.black,
                                fontSize: 15,
                                fontWeight: FontWeight.w600,
                  ...
                  Column(
                    children: List.generate(
                      ...
                      (index) => FieldWithLabel(
                          ...
                          readOnly: true,
                          controller: PackageCubit.get(context)
                              .fatherOrMotherNameControllers[index],
                          label: context.fatherOrMotherName,
                          borderColor: AppColors.grey3,
                          suffix: InkWell(
                            onTap: () {
                              setState(() {
